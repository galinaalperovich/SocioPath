...
class EventFeature:
    def __init__(self, micro_property, driver):
        ...
        self.my_depth = self.__get_my_depth()
    ...
    def __get_my_depth(self):
        return None
        # return self.driver.execute_script("return arguments[0].parents().length;", self.webelement) TODO JQuery
