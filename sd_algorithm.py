...
class SDAlgorithm():
        ...
        if article_exists:
            ...
            if max_group in grouped_comments:
                ...
                if self.big_areas_in_same_level(article, grouped_comments, max_group) and not validated:
                    print
                    Tcolors.INFO + " Multiple similar regions detected!"
                    print
                    "Class: "
                    print
                    Tcolors.RES + " " + grouped_comments[max_group][0].class_name
                    print
                    "Texts: "
                    ...
                    print
                    print
                    Tcolors.INFO + " No comments found."
                    return article, None, None
                elif context_validated:
                    print
                    print
                    Tcolors.INFO + " Article with comments detected!"
                    self.print_article(article)
                    print
                    print
                    "Comment class:"
                    print
                    Tcolors.RES + " " + max_group
                    print
                    "Comments:"
    ...
    def candidate_context_validated(self, article, grouped_comments, max_group):
        ...
        """
        print
        Tcolors.ACT + " Validating candidate comment group based on its content..."
    ...
    def print_article(self, article):
        ...
        """
        print
        Tcolors.INFO + " Article detected!"
        print
        "Article class: "
        print
        Tcolors.RES + " " + repr(article.class_name)
        print
        "Article title: "
        print
        article.get_ancestor_title()
        print
        "Article text: "
        print
        article.full_text.replace("\n", " ")
